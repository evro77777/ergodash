...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Qwerty
   * ,----------------------------------------------------------------------------------------------------------------------.
   * | ESC  |  1   |  2   |  3   | 4    |  5   | del  |                    |vup   |  6   | 7    | 8    |   9  | 0    | close|
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * |  Tab |   Q  |   W  |   E  |   R  |   T  |KC_BRK|                    |vdown |   Y  |   U  |   I  |   O  |   P  |  [   |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * | alt  |   A  |   S  |   D  |   F  |   G  | Tab  |                    | mute |   H  |   J  |   K  |   L  |   ;  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * |win   |   Z  |   X  |   C  |   V  |   B  |||||||| alt  |      |tab   ||||||||   N  |   M  |   ,  |   .  |   /  | ?    |
   * |      |      |      |  lang||||||||Lower| Space | ctrl ||||||| | Enter|shift|BspRse||||||| W_C_L| W_C_R|  ]    | Rctrl|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( 
     TD(TD_ESC_GRV),   KC_1,    KC_2,    KC_3,           KC_4,    KC_5,   KC_DEL,                        KC_VOLU,          KC_6,             KC_7,                KC_8,                KC_9,    KC_0,       LALT(KC_F4),
     KC_TAB,           KC_Q,    KC_W,    KC_E,           KC_R,    KC_T,   KC_BRK,                        KC_VOLD,          KC_Y,             KC_U,                KC_I,                KC_O,    KC_P,       KC_LBRC,
     KC_LALT,          KC_A,    KC_S,    KC_D,           KC_F,    KC_G,   KC_TAB,                        KC_MUTE,          KC_H,             KC_J,                KC_K,                KC_L,    KC_SCLN,    KC_QUOT,
     KC_LGUI,          KC_Z,    KC_X,    KC_C,           KC_V,    KC_B,         KC_LALT,           KC_TAB,                 KC_N,             KC_M,                KC_COMM,             KC_DOT,  KC_SLSH,    KC_QUES,
     XXXXXXX,          XXXXXXX, XXXXXXX, LGUI(KC_SPC),   LOWER,   KC_SPC,       CTL_ENT ,          KC_ENT,OSM(MOD_LSFT),   LT(2,KC_BSPC),    LGUI(LCTL(KC_LEFT)), LGUI(LCTL(KC_RGHT)),          KC_RBRC,    KC_RCTL
  ),
  ...
  [_LOWER] = LAYOUT( 
    ...
    KC_LSFT, XXXXXXX,    XXXXXXX, LCTL(KC_PGUP),      LCTL(KC_PGDOWN),  XXXXXXX,              XXXXXXX,      XXXXXXX,           KC_MINS,       KC_PLUS,        KC_EQUAL,      KC_UNDERSCORE,   KC_BSLS,        KC_RSFT,
