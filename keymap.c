...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |      |  lang||||||||Lower| Space | ctrl ||||||| | Enter|shift|BspRse||||||| W_C_L| W_C_R |  ]   |      |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( 
     ...
     XXXXXXX,          XXXXXXX, XXXXXXX, LGUI(KC_SPC),   LOWER,   KC_SPC,       CTL_ENT ,          KC_ENT,OSM(MOD_LSFT),   LT(2,KC_BSPC),    LGUI(LCTL(KC_LEFT)), LGUI(LCTL(KC_RGHT)),          KC_RBRC,    XXXXXXX
  ),
