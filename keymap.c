...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | shift|   Z  |   X  |   C  |   V  |   B  |||||||| lgui |      |ALT_TB||||||||   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
  ...
  [_QWERTY] = LAYOUT( 
    ...
    KC_LSFT,           KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                    KC_LGUI,     ALT_TAB,  KC_N,    KC_M,     KC_COMM, KC_DOT,  KC_SLSH,    KC_RSFT,
     XXXXXXX,          XXXXXXX,  XXXXXXX,  LGUI(KC_SPC),   KC_DEL,  LT(1,KC_SPC),  CTL_ENT,     KC_ENT , OSM(MOD_LSFT), LT(2,KC_BSPC),    LGUI(LCTL(KC_LEFT)), LGUI(LCTL(KC_RGHT)), KC_RBRC,    KC_RCTL
  ),
